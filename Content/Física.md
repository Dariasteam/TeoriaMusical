...
- Frecuencia (f): Cantidad de oscilaciones por segundo. Su unidad de medida es el Hercio (Hz). A mayor número de oscilaciones más _agudo_ percibimos el sonido.

?> El oído humano de un recién nacido es capaz de percibir un rango de frecuencias de 20 a 20.000 _Hz_.
